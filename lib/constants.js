(function initConstants(globalScope) {
  ...
  root.Constants = {
    ...
    STORAGE_KEYS: {
      ...
      SYNC_STATUS: "avtofair.syncStatus"
    },
    MESSAGE_TYPES: {
      ...
      REFRESH_WATCHLIST_STALE: "AVTOFAIR_REFRESH_WATCHLIST_STALE",
      ...
      IMPORT_BACKUP: "AVTOFAIR_IMPORT_BACKUP",
      EXPORT_BACKUP: "AVTOFAIR_EXPORT_BACKUP",
      RUN_CLOUD_SYNC: "AVTOFAIR_RUN_CLOUD_SYNC",
      GET_SYNC_STATUS: "AVTOFAIR_GET_SYNC_STATUS"
    },
    ...
    STALE_REFRESH_AGE_MS: 1000 * 60 * 60 * 24 * 3,
    SUPPORT_URL: "https://paypal.me/TiniFlegar",
